...
CROC_WORDS = [
    ...
    "Галушка","Молоко","Резак","Четверг","Макаронсы","Мохнатость","Демирюбанк","Инженеры",
    "Мужчина","Боксер","Бруни","Матиз","Мазда","Пальма","Мохнатость","Окр","Айслатте на миндальном","Априорность","Апостериорности",
    "Ношпа","Миллениал", "Шредер","Мегамозг","Сигмабой","Сигмагерл","Попыт","Симпл димл","Егор крид","Эдвард","Бродяга","Джейкоб","Оборотень","Кравосися","Гольф",
